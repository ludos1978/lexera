...
| **Interaction** | [Drag/Drop](ux/dragdrop/SPEC.md), [Menus](ux/menus/SPEC.md), [Search](ux/search/SPEC.md), [Export](ux/export/SPEC.md), [Actions](ux/actions/SPEC.md), [Menu Contributors](ux/menu-contributors/SPEC.md), [Board Settings](ux/board-settings/SPEC.md), [Panels](ux/panels/SPEC.md), [Frontend Tests](ux/panels/FRONTEND-TESTS.md) |
