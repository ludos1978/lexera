...
- [ ] the kanban board view tab headers have a burger menu instead of a close button. the burger menu must be replaced by the close button, so it's the same as all other views!
