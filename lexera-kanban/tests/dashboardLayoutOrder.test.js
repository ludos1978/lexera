...
describe('dashboard layout order', () => {
  it('renders results before pinned searches in the main sidebar markup', () => {
    const resultsIndex = indexHtml.indexOf('data-dashboard-group-key="results"');
    const pinnedIndex = indexHtml.indexOf('data-dashboard-group-key="pinned"');
