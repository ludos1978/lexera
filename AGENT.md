...
For any larger new feature required, check if there is a library available that solves the problem already. Do not use libraries that are less then a year old!
